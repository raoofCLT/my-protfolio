        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 slide-up">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-6 text-gray-400">
                <div className="flex items-center gap-2 glass-effect glass-effect-hover px-4 py-2 rounded-lg card-hover">
                  <MapPin className="w-4 h-4 text-blue-400" />
                  <span>Kerala, India</span>
                </div>
                <div className="flex items-center gap-2 glass-effect glass-effect-hover px-4 py-2 rounded-lg card-hover-reverse">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:hidden">
              ...
              <Link 
                to="/projects"
                className="px-8 py-4 glass-effect glass-effect-hover rounded-2xl font-semibold transition-all duration-500 hover:scale-105 morphing-shadow flex items-center gap-2 card-hover-reverse group"
              >
                View Projects
          ...
          <div className="space-y-6 fade-in-scale" style={{ animationDelay: '0.3s' }}>
            <div className="grid grid-cols-2 gap-6">
              <div className="glass-effect glass-effect-hover rounded-2xl p-6 text-center card-hover morphing-shadow glow-effect perspective-card">
                <div className="text-4xl font-bold text-blue-400 mb-2">10+</div>
                <div className="text-gray-400">Projects Completed</div>
                <Star className="w-6 h-6 text-yellow-400 mx-auto mt-2" />
              </div>
              <div className="glass-effect glass-effect-hover rounded-2xl p-6 text-center card-hover-reverse morphing-shadow glow-effect perspective-card">
            ...
            <div className="glass-effect glass-effect-hover rounded-2xl p-6 card-hover morphing-shadow glow-effect perspective-card">
